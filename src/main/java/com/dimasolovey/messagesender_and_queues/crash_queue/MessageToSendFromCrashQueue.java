...
import com.dimasolovey.utilites.Compression;
 ...
 */
public class MessageToSendFromCrashQueue {
    ...
    public static synchronized String getMessageFromJsonFormat (String jsonMessage, long timestamp, boolean isCompressed) {
        try {
            if (isCompressed) {
               jsonMessage = Compression.decompress(jsonMessage);
            }
            ...
            String message = "Crash:" + imei + "," + "Timestamp{" + "timestamp=" + timestamp + "}" + ",";
